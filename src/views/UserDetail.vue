...
<script setup>
  ...
  import { useUserStore, fetchUser, setLoadUserError } from '/src/stores/usersStore.mjs';
  ...
  import SimpleTabs from '/src/components/SimpleTabs.vue';
  import CatsByUser from '/src/components/CatsByUser.vue';
  import PhotosByUser from '/src/components/PhotosByUser.vue';
